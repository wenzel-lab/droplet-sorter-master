# Master Repository of the Open Hardware Design of the 
# Fluorescence Activated (Microfluidic) Droplet Sorter (FADS) [![Open Source Love](https://badges.frapsoft.com/os/v1/open-source.svg?v=103)](https://github.com/ellerbrock/open-source-badges/)
